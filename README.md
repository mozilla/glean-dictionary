...
https://dictionary.telemetry.mozilla.org/api/metrics_search_burnham?search=techno
...
http://localhost:8888/api/metrics_search_burnham?search=techno
http://localhost:8888/api/metrics_search_firefox_legacy?search=ms
